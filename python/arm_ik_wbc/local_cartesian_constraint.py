...
class LocalCartesianConstraint:
    """ Class Input:
    ...
    """
    def __init__(self, frame_index, reference_frame, base_index, x, y, z, roll, pitch, yaw):
    ...
    def CartesianC(self):
        ...
        C_f = pin.getFrameJacobian(self.robot_model, self.robot_data, self.frame_index, self.reference_frame)
        
        C_b = pin.getFrameJacobian(self.robot_model, self.robot_data, self.base_index, self.reference_frame)
